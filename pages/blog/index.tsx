    ...
    <Layout>
      ...
      <Row justify="center" align="top">
        <Col xs={23} sm={20} md={20} lg={13} xl={12}>
          <BlogPost id={Post[0].id} title={Post[0].title} image={Post[0].img} />
          <BlogPost id={Post[1].id} title={Post[1].title} image={Post[1].img} />
          <BlogPost id={Post[2].id} title={Post[2].title} image={Post[2].img} />
